...
drawmodel(void)
{
    if (!pmodel) 
	{
		...
		// pmodel = glmReadOBJ("C:/Users/erick/Documents/GitHub/Laboratorio-Grafica/Practica/resources/data/al.obj");
		pmodel = glmReadOBJ("../resources/data/al.obj");
...
screen_menu(int value)
{
    ...
    case 'a':
        ...
        name = "../resources/data/al.obj";

        break;
    case 's':
        //name = "data/soccerball.obj";
        name = "../resources/data/soccerball.obj";

        break;
    case 'd':
        //name = "data/dolphins.obj";
        name = "../resources/data/dolphins.obj";

        break;
    case 'f':
        //name = "data/flowers.obj";
        name = "../resources/data/flowers.obj";

        break;
    case 'j':
        //name = "data/f-16.obj";
        name = "../resources/data/f-16.obj";

        break;
    case 'p':
        //name = "data/porsche.obj";
        name = "../resources/data/porsche.obj";

        break;
    case 'r':
        //name = "data/rose+vase.obj";
        name = "../resources/data/rose+vase.obj";
